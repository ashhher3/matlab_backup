    ...
    for iFilter = 1:Nfilters
        ...
        switch filterName
            ...
            case {'EM1stOrd','EM2ndOrd','EM3rdOrd'}
                filename = ['LDSparams',filterName,params.MODEL,'ManyXprmts.mat'];
            ...
            case 'rEFH'
                %%%filename = ['wts',params.MODEL,'ManyXprmts.mat'];
                %%%load(['dynamical\finalwts\',filename]);
                filename = ['wts',params.MODEL,'ManyXprmts150217sigmoid.mat'];
                load(['dynamical\nonfinalwts\',filename]);
