...
if isfield(Q,'stims')
    ...
    switch params.MODEL
        ...
        case {'1DrEFH','2DrEFH','1DtRBM','1DrEFHwithEC','2DrEFHwithEC',...
                '3DrEFH','HVNdamped','1DrEFHbern'}
            [S,filterdata] = trajectoryGen(Nbatches,params.smin,params.smax,params);
...
switch params.MODEL
    ...
    case {'1DrEFH','2DrEFH','1DtRBM','3DrEFH',...
            '1DrEFHwithEC','2DrEFHwithEC','HVNdamped','1DrEFHbern'}
        ...
        Nbatches = Nexamples/Ncases;
        
        %%% a little hacky....
        Rrecur = -ones(Ncases,Nhids,Nbatches);
        Rrecur(:,:,1) = 0;
...
%%% to be the same all across all nine (or whatever) repeats of for the
%%% toroidal encoding.
